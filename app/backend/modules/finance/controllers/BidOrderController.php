...
use app\backend\modules\finance\services\BidOrderService;
...
class BidOrderController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('finance.bidorder.list')->render();
    }
    ...
    public function detail(Request $request)
    {
        ...
        if (request()->ajax()) {
            ...
            $data = $this->bidOrderService->detail($order_id);
            return $this->successJson('ok', $data);

        }

        return view('finance.bidorder.detail', ['id' => $order_id]);
    ...
    public function confirmPay(Request $request)
    {
        ...
        $this->bidOrderService->confirmPay($order_id,$swift_img);
    ...
    {
        $order_id = $request->input('id');
        $this->bidOrderService->revokePay($order_id);
        return $this->successJson('ok');
    }
    ...
    {
        $order_id = $request->input('id');
        $data = $this->bidOrderService->getPayVoucher($order_id);
        return $this->successJson('ok',$data);
    }
