...
class   BalanceRechargeRecords extends BalanceRecharge
{
    ...
    {
        if (intval($search['uid'])) $query->where('member_id', intval($search['uid']));
        ...
        if ($search['realname'] || ($search['level_id'] !== '' && $search['level_id'] !== null) || $search['group_id']) {
            $query->whereHas('member', function ($member) use ($search) {
                ...
                if (($search['level_id'] !== '' && $search['level_id'] !== null)) {
