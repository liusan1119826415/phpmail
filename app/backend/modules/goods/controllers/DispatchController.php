...
//            'shopset' => $shopset
//        ])->render();
        $dispatch_cal_type = \Setting::get('dispatch.dispatch_cal_type') ?? 0;
        return view('goods.dispatch.list', ['dispatch_cal_type' => $dispatch_cal_type])->render();
    }
...
//        ])->render();
    ...
    {
        $dispatch_cal_type = request()->input('dispatch_cal_type');
        \Setting::set('dispatch.dispatch_cal_type', $dispatch_cal_type);
