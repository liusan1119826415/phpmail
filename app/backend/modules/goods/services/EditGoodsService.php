        ...
        if ($goods_data) {
            ...
            if ($validator->fails()) {
                ...
                if ($this->goods_model->save()) {
                    ...
                    $job = new GeneratePdfJob($install_guide,$this->goods_model->id,\YunShop::app()->uniacid,'install_guide');
                    DispatchesJobs::dispatch($job,DispatchesJobs::LOW);
                    ...
                    //关联商品保存
                    if($related_goods_ids){
                        GoodsRelation::relateToGoods($this->goods_model->id,$related_goods_ids);
                    }
