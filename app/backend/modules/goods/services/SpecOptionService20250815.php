               ...
               /* */
                ...
                if (request()->hasFile($d3ModelUrlKey)) {
                   ...
                   /* $extension = $file->getClientOriginalExtension() ?: 'glb';
                    ...
                    // 上传到 OSS 的队列任务
                    $d3ModelUrl_ori = $this->uploadOss(request()->File($d3ModelUrlKey));
...
//                    "d3ModelUrl_weld"=>$d3ModelUrl_weld,
//                    "d3ModelUrl_ori"=>$d3ModelUrl_ori
                ...
                if($option['model_param']){
                    ...
                    //更改异步
//                    $job = new UpdateModelJob($option_id, $this->uniacid, $option['model_param']);
