...
//    ],
            ...
            'industry_manage' => [
                ...
                'child' => [
                    ...
                    'case_lable' => [
                        ...
                        'sort' => 0,
                        'item' => 'case_lable',
                        'parents' => ['industry_manage'],
                        'child' => [
                            'case_lable_get_data' => [
                                'name' => '获取列表',
                                'url' => 'industry.case-lable.getData',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'case_lable_get_data',
                                'parents' => ['industry_manage', 'case_lable'],
                            ],
                            'case_lable_add' => [
                                'name' => '新增',
                                'url' => 'industry.case-lable.add',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                            ...
                            'case_lable_edit' => [
                                'name' => '编辑',
                                'url' => 'industry.case-lable.edit',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'case_lable_edit',
                                'parents' => ['industry_manage', 'case_lable'],
                            ],
                        ],
                    ],
                    ...
                    /* 'industry_case' => [
                         'name' => '行业案例',
                         'url' => 'industry.industry-case.index',
                         'url_params' => '',
                         'permit' => 1,
                         'style' => 'pulish',
                         'menu' => 1,
            ...
            'logistic_install_manage' => [
                'name' => '物流安装',
                'url' => 'feight.logistics.index',
                'url_params' => '',
                'permit' => 1,
                'menu' => 1,
                'top_show' => 0,
                ...
                'child' => [
                    ...
                    'logistic_trace' => [
                        ...
                        'sort' => 0,
                        'item' => 'logistic_trace',
                        'parents' => ['logistic_install_manage'],
                        'child' => [
                            'logistic_trace_get_data' => [
                                'name' => '获取列表',
                                'url' => 'feight.logistics.getData',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_get_data',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_publishOrder' => [
                                'name' => '发布订单',
                                'url' => 'feight.logistics.publishOrder',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_publishOrder',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_deliveryPoint' => [
                                'name' => '查看提货点',
                                'url' => 'feight.logistics.deliveryPoint',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_deliveryPoint',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_getVoucher' => [
                                'name' => '查看凭证',
                                'url' => 'feight.logistics.getVoucher',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_getVoucher',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_getQuote' => [
                                'name' => '获取报价',
                                'url' => 'feight.logistics.getQuote',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_getQuote',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_dispense' => [
                                'name' => '分配物流',
                                'url' => 'feight.logistics.dispense',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_dispense',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_deliveryGoods' => [
                                'name' => '查看提货清单',
                                'url' => 'feight.logistics.deliveryGoods',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_deliveryGoods',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_deliveryBill' => [
                                'name' => '查看提货单',
                                'url' => 'feight.logistics.deliveryBill',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_deliveryBill',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_detail' => [
                                'name' => '获取详情',
                                'url' => 'feight.logistics.detail',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_detail',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_revokeDispense' => [
                                'name' => '撤回分配',
                                'url' => 'feight.logistics.revokeDispense',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_revokeDispense',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'logistic_trace_lockPrice' => [
                                'name' => '锁定价格',
                                'url' => 'feight.logistics.lockPrice',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'logistic_trace_lockPrice',
                                'parents' => ['logistic_install_manage'],
                            ],
                        ],
                    ],

                    'install_dispense_trace' => [
                        'name' => '安装分配管理',
                        'url' => 'install.install.index',
                        'url_params' => '',
                        'permit' => 1,
                        'style' => 'pulish',
                        'menu' => 1,
                        ...
                        'child' => [
                            ...
                            'install_trace_get_data' => [
                                'name' => '获取列表',
                                'url' => 'install.install.getData',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                            ...
                            'install_trace_getFloorGoods' => [
                                'name' => '获取货品清单',
                                'url' => 'install.install.getFloorGoods',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_trace_getFloorGoods',
                                'parents' => ['logistic_install_manage'],
                            ],

                            'install_trace_getQuote' => [
                                'name' => '获取报价',
                                'url' => 'install.install.getQuote',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_trace_getQuote',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'install_trace_dispense' => [
                                'name' => '获取报价',
                                'url' => 'install.install.dispense',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_trace_dispense',
                                'parents' => ['logistic_install_manage'],
                            ],

                            'install_trace_detail' => [
                                'name' => '订单详情',
                                'url' => 'install.install.detail',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_trace_detail',
                                'parents' => ['logistic_install_manage','install_dispense_trace'],
                            ],
                            'install_trace_revokeDispense' => [
                                'name' => '撤回分配',
                                'url' => 'install.install.revokeDispense',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_trace_revokeDispense',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'install_trace_lockPrice' => [
                                'name' => '锁定价格',
                                'url' => 'install.install.lockPrice',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_trace_lockPrice',
                                'parents' => ['logistic_install_manage'],
                            ],
                            'install_trace_getLogisticsTracks' => [
                                'name' => '获取物流',
                                'url' => 'install.install.getLogisticsTracks',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_trace_getLogisticsTracks',
                                'parents' => ['logistic_install_manage'],
                            ],
...
//                            ],
                            ...
                            'goods_export_template_list' => [
                                'name' => '获取商品导出模板列表',
                                'url' => 'goods.goods.export-template-list',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'goods_export_template_list',
                                'parents' => ['Goods', 'goods_goods'],
                            ],
                            'goods_del_export_template' => [
                                'name' => '删除商品导出模板',
                                'url' => 'goods.goods.del-export-template',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'goods_del_export_template',
                                'parents' => ['Goods', 'goods_goods'],
                            ],
                            'goods_save_export_template' => [
                                'name' => '保存商品导出模板',
                                'url' => 'goods.goods.save-export-template',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'goods_save_export_template',
                                'parents' => ['Goods', 'goods_goods'],
                            ],
                            'goods_goods_export' => [
                                'name' => '商品导出',
                    ...
                    'material_uv_manage' => [
                        'name' => 'UV管理',
                        'url' => 'goods.material-uv.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-file-excel-o',
                        'sort' => '2',
                        'item' => 'material_uv_manage',
                        'parents' => ['Goods'],
                        'child' => [
                            'goods_material_uv_get_data' => [
                                'name' => '获取数据',
                                'url' => 'goods.material-uv.get-data',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_material_uv_get_data',
                                'parents' => ['Goods', 'material_uv_manage'],
                            ],
                            'goods_material_uv_view' => [
                                'name' => '查看',
                                'url' => 'goods.material-uv.edit-view',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_material_uv_view',
                                'parents' => ['Goods', 'material_uv_manage'],
                            ],

                            'goods_material_uv_add' => [
                                'name' => '新增',
                                'url' => 'goods.material-uv.add',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_material_uv_add',
                                'parents' => ['Goods', 'material_uv_manage'],
                            ],
                            'goods_material_uv_edit' => [
                                'name' => '修改',
                                'url' => 'goods.material-uv.edit',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_material_uv_edit',
                                'parents' => ['Goods', 'material_uv_manage'],
                            ],
                            'goods_material_uv_delete' => [
                                'name' => '删除',
                                'url' => 'goods.material-uv.delete',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_material_uv_delete',
                                'parents' => ['Goods', 'material_uv_manage'],
                            ],
                    ...
                    'goods_styles_manage' => [
                        'name' => '商品风格管理',
                        'url' => 'goods.style.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-file-excel-o',
                        'sort' => '2',
                        'item' => 'goods_styles_manage',
                        'parents' => ['Goods'],
                        'child' => [
                            'goods_styles_get_data' => [
                                'name' => '获取数据',
                                'url' => 'goods.style.get-data',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_styles_get_data',
                                'parents' => ['Goods', 'goods_styles_manage'],
                            ],
                            'goods_styles_view' => [
                                'name' => '查看',
                                'url' => 'goods.style.edit-view',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_styles_view',
                                'parents' => ['Goods', 'goods_styles_manage'],
                            ],
                            ...
                            'goods_styles_add' => [
                                ...
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_styles_add',
                                'parents' => ['Goods', 'goods_styles_manage'],
                            ],
                            'goods_styles_edit' => [
                                'name' => '修改',
                                'url' => 'goods.style.edit',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_styles_edit',
                                'parents' => ['Goods', 'goods_styles_manage'],
                            ],
                            'goods_styles_delete' => [
                                'name' => '删除',
                                'url' => 'goods.style.delete',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_styles_delete',
                                'parents' => ['Goods', 'goods_styles_manage'],
                            ],
                    ...
                    'craft_material_manage' => [
                        'name' => '工艺材质管理',
                        'url' => 'goods.material.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-file-excel-o',
                        'sort' => '2',
                        'item' => 'craft_material_manage',
                        'parents' => ['Goods'],
                        'child' => [
                            'craft_material_get_data' => [
                                'name' => '获取数据',
                                'url' => 'goods.material.get-data',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'craft_material_get_data',
                                'parents' => ['Goods', 'craft_material_manage'],
                            ],
                            'craft_material_view' => [
                                'name' => '查看',
                                'url' => 'goods.material.edit-view',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'craft_material_view',
                                'parents' => ['Goods', 'craft_material_manage'],
                            ],
                            ...
                            'craft_material_add' => [
                                ...
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'craft_material_add',
                                'parents' => ['Goods', 'craft_material_manage'],
                            ],
                            'craft_material_edit' => [
                                'name' => '修改',
                                'url' => 'goods.material.edit',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'craft_material_edit',
                                'parents' => ['Goods', 'craft_material_manage'],
                            ],
                            'craft_material_delete' => [
                                'name' => '删除',
                                'url' => 'goods.material.delete',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'craft_material_delete',
                                'parents' => ['Goods', 'craft_material_manage'],
                            ],
                    ...
                    'ppt_template_manage' => [
                        ...
                        'icon' => 'fa-file-excel-o',
                        'sort' => '2',
                        'item' => 'ppt_template_manage',
                        'parents' => ['Goods'],
                        'child' => [
                            'ppt_template_get_data' => [
                                'name' => '获取数据',
                                'url' => 'goods.ppt.get-data',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'ppt_template_get_data',
                                'parents' => ['Goods', 'ppt_template_manage'],
                            ],
                            'ppt_template_view' => [
                                'name' => '查看',
                                'url' => 'goods.ppt.edit-view',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'ppt_template_view',
                                'parents' => ['Goods', 'ppt_template_manage'],
                            ],
                            ...
                            'ppt_template_edit' => [
                                ...
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'ppt_template_edit',
                                'parents' => ['Goods', 'ppt_template_manage'],
                            ],
                            'ppt_template_delete' => [
                                'name' => '删除',
                                'url' => 'goods.ppt.delete',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'ppt_template_delete',
                                'parents' => ['Goods', 'ppt_template_manage'],
                            ],
                    ...
                    'base_material_mangage' => [
                        'name' => '基础色材质',
                        'url' => 'goods.base-material.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-file-excel-o',
                        'sort' => '2',
                        'item' => 'base_material_mangage',
                        'parents' => ['Goods'],
                        'child' => [
                            'base_material_get_data' => [
                                'name' => '获取数据',
                                'url' => 'goods.base-material.get-data',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'base_material_get_data',
                                'parents' => ['Goods', 'base_material_mangage'],
                            ],

                            'base_material_edit_view' => [
                                'name' => '查看数据',
                                'url' => 'goods.base-material.edit-view',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'base_material_edit_view',
                                'parents' => ['Goods', 'base_material_mangage'],
                            ],
                            'base_material_add' => [
                                'name' => '新增数据',
                                'url' => 'goods.base-material.add',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'base_material_add',
                                'parents' => ['Goods', 'base_material_mangage'],
                            ],
                            'base_material_edit' => [
                                'name' => '修改数据',
                                'url' => 'goods.base-material.edit',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'base_material_edit',
                                'parents' => ['Goods', 'base_material_mangage'],
                            ],
                            'base_material_delete' => [
                                'name' => '删除数据',
                                'url' => 'goods.base-material.delete',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'base_material_delete',
                                'parents' => ['Goods', 'base_material_mangage'],
                            ],
                            'base_material_batchDelete' => [
                                'name' => '批量删除',
                                'url' => 'goods.base-material.batchDelete',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'base_material_batchDelete',
                                'parents' => ['Goods', 'base_material_mangage'],
                            ],
                    ...
                    'install_dispatch' => [
                        'name' => '物流费用管理',
                        'url' => 'goods.logistics.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-truck',
                        'sort' => '4',
                        'item' => 'install_dispatch.index',
                        'parents' => ['Goods'],
                        'child' => [

                            'install_dispatch_data' => [
                                'name' => '获取数据',
                                'url' => 'goods.logistics.dispatchData',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '4',
                                'item' => 'install_dispatch_data',
                                'parents' => ['Goods', 'install_dispatch']
                            ],
                            'install_dispatch_edit_save' => [
                                'name' => '编辑页面渲染',
                                'url' => 'goods.logistics.edit-save',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '4',
                                'item' => 'install_dispatch_edit_save',
                                'parents' => ['Goods', 'install_dispatch']
                            ],

                            'install_dispatch_quick_edit' => [
                                'name' => '快速修改',
                                'url' => 'goods.logistics.quick-edit',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '4',
                                'item' => 'install_dispatch_quick_edit',
                                'parents' => ['Goods', 'install_dispatch']
                            ],


                            'install_dispatch_add_one' => [
                                'name' => '新增',
                                'url' => 'goods.logistics.add',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_dispatch_add_one',
                                'parents' => ['Goods', 'install_dispatch'],
                            ],

                            'install_dispatch_alter' => [
                                'name' => '修改',
                                'url' => 'goods.logistics.edit',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_dispatch_alter',
                                'parents' => ['Goods', 'install_dispatch'],
                            ],

                            'install_dispatch_delete' => [
                                'name' => '删除',
                                'url' => 'goods.logistics.delete',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_dispatch_delete',
                                'parents' => ['Goods', 'install_dispatch'],
                            ],
                        ],
                    ],
                    ...
                    'install_fee_manage' => [
                        ...
                        'child' => [
                            ...
                            'install_dispatch_data_1' => [
                                'name' => '获取数据',
                                'url' => 'goods.install.dispatchData',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '4',
                                'item' => 'install_dispatch_data_1',
                                'parents' => ['Goods', 'install_fee_manage']
                            ],
                            'install_dispatch_edit_save_1' => [
                                'name' => '编辑页面渲染',
                                'url' => 'goods.install.edit-save',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '4',
                                'item' => 'install_dispatch_edit_save_1',
                                'parents' => ['Goods', 'install_fee_manage']
                            ],

                            'install_dispatch_quick_edit_1' => [
                                'name' => '快速修改',
                                'url' => 'goods.install.quick-edit',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '4',
                                'item' => 'install_dispatch_quick_edit_1',
                                'parents' => ['Goods', 'install_fee_manage']
                            ],


                            'install_dispatch_add_one_1' => [
                                'name' => '新增',
                                'url' => 'goods.install.add',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_dispatch_add_one_1',
                                'parents' => ['Goods', 'install_fee_manage'],
                            ],

                            'install_dispatch_alter_1' => [
                                'name' => '修改',
                                'url' => 'goods.install.edit',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_dispatch_alter_1',
                                'parents' => ['Goods', 'install_fee_manage'],
                            ],

                            'install_dispatch_delete_1' => [
                                'name' => '删除',
                                'url' => 'goods.install.delete',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'install_dispatch_delete_1',
                                'parents' => ['Goods', 'install_fee_manage'],
                            ],
                        ],
                    ],
                    ...
                    'goods_dispatch' => [
                        ...
                        'child' => [
                            'dispatch_cal_type' => [
                                'name' => '配送设置订单运费计算',
                                'url' => 'goods.dispatch.cal-type',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => '4',
                                'item' => 'dispatch_cal_type',
                                'parents' => ['Goods', 'goods_dispatch']
                            ],
...
//                            ],
                    ...
                    'coupon' => [
                        ...
                        'child' => [
                            ...
                            'coupon_coupon_search_brand' => [
                                'name' => '搜索品牌',
                                'url' => 'coupon.coupon.searchBrand',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'coupon_coupon_search_brand',
                                'parents' => ['Goods', 'coupon'],
                            ],
                            ...
                            'coupon_use_log_export' => [
                                'name' => '使用记录导出',
                                'url' => 'coupon.coupon-use.export',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 1,
                                'icon' => 'fa-pencil',
                                'sort' => '3',
                                'item' => 'coupon_use_log_export',
                                'parents' => ['Goods', 'coupon'],
                            ],
                        ...
                        'child' => [
                            'goods_discount_set_all' => [
                                ...
                                'child' => [
                                    ...
                                    'goods_discount_set_good_save' => [
                                        'name' => '同步更新商品折扣设置',
                                        'url' => 'discount.batch-discount.goods-save',
                                        'url_params' => '',
                                        'permit' => 0,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_discount_set_good_save',
                                        'parents' => ['Goods', 'discount_set', 'goods_discount_set_all'],
                                        'child' => []
                                    ],
                                ],
                            ...
                            'goods_dispatch_freight' => [
                                ...
                                'child' => [
                                    ...
                                    'goods_dispatch_get_all_category' => [
                                        'name' => '获取所有分类',
                                        'url' => 'discount.batch-dispatch.get-all-cate',
                                        'url_params' => '',
                                        'permit' => 0,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_dispatch_get_all_category',
                                        'parents' => ['Goods', 'discount_set', 'goods_dispatch_freight'],
                                        'child' => []
                                    ],
                                    'goods_dispatch_set_good_save' => [
                                        'name' => '同步更新商品运费折扣设置',
                                        'url' => 'discount.batch-dispatch.goods-save',
                                        'url_params' => '',
                                        'permit' => 0,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_dispatch_set_good_save',
                                        'parents' => ['Goods', 'discount_set', 'goods_dispatch_freight'],
                                        'child' => []
                                    ],
                                ],
                            ...
                            'goods_batch_balance' => [
                                'name' => '余额批量设置',
                                'url' => 'discount.batch-balance.index',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 1,
                                'icon' => '',
                                'sort' => '2',
                                'item' => 'goods_batch_balance',
                                'parents' => ['Goods', 'discount_set'],
                                'child' => [
                                    'goods_batch_balance_get_set' => [
                                        'name' => '获取设置',
                                        'url' => 'discount.batch-balance.get-set',
                                        'url_params' => '',
                                        'permit' => 0,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_batch_balance_get_set',
                                        'parents' => ['Goods', 'discount_set', 'goods_batch_balance'],
                                        'child' => []
                                    ],
                                    'goods_batch_set_balance' => [
                                        'name' => '折扣设置',
                                        'url' => 'discount.batch-balance.balance-set',
                                        'url_params' => '',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_batch_set_balance',
                                        'parents' => ['Goods', 'discount_set', 'goods_batch_balance'],
                                        'child' => []
                                    ],
                                    'goods_balance_select_category' => [
                                        'name' => '分类查询',
                                        'url' => 'discount.batch-balance.select-category',
                                        'url_params' => '',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_balance_select_category',
                                        'parents' => ['Goods', 'discount_set', 'goods_batch_balance'],
                                        'child' => []
                                    ],
                                    'goods_batch_balance_save' => [
                                        'name' => '运费设置',
                                        'url' => 'discount.batch-balance.balance-save',
                                        'url_params' => '',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_batch_balance_save',
                                        'parents' => ['Goods', 'discount_set', 'goods_batch_balance'],
                                        'child' => []
                                    ],
                                    'goods_balance_update_balance' => [
                                        'name' => '修改设置',
                                        'url' => 'discount.batch-balance.update-balance',
                                        'url_params' => '',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_balance_update_balance',
                                        'parents' => ['Goods', 'discount_set', 'goods_batch_balance'],
                                        'child' => []
                                    ],
                                    'goods_batch_balance_delete' => [
                                        'name' => '删除设置',
                                        'url' => 'discount.batch-balance.delete-balance',
                                        'url_params' => '',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_batch_balance_delete',
                                        'parents' => ['Goods', 'discount_set', 'goods_batch_balance'],
                                        'child' => []
                                    ],
                                    'goods_batch_balance_get_category_child' => [
                                        'name' => '获取子类分类',
                                        'url' => 'discount.batch-balance.get-child',
                                        'url_params' => '',
                                        'permit' => 0,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_batch_balance_get_category_child',
                                        'parents' => ['Goods', 'discount_set', 'goods_batch_balance'],
                                        'child' => []
                                    ],
                                    'goods_batch_balance_get_all_category' => [
                                        'name' => '获取所有分类',
                                        'url' => 'discount.batch-balance.get-all-cate',
                                        'url_params' => '',
                                        'permit' => 0,
                                        'menu' => 0,
                                        'icon' => 'fa-sitemap',
                                        'sort' => '2',
                                        'item' => 'goods_batch_balance_get_all_category',
                                        'parents' => ['Goods', 'discount_set', 'goods_batch_balance'],
                                        'child' => []
                                    ],
                                ],
                ...
                'child' => [
                    ...
                    'member_all' => [
                        ...
                        'child' => [
                            ...
                            'member_chart_check' => [
                                'name' => '查看会员登录端统计',
                                'url' => 'member.member.member-chart',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                            ...
                            'member_detail' => [
                                ...
                                'child' => [
                                    ...
                                    'get_member_tags' => [
                                        'name' => '获取会员标签信息',
                                        'url' => 'member.member.get-member-tags',
                                        'url_params' => '',
                                        'permit' => 0,
                                        'menu' => 0,
                                        'icon' => '',
                                    ...
                                    'get_member_mini_qr' => [
                                        'name' => '获取会员插件主页小程序二维码',
                                        'url' => 'member.member.get-mini-app-page-uri',
                                        'url_params' => '',
                                        'permit' => 0,
                                        'menu' => 0,
                                        'icon' => '',
                                        'sort' => 0,
                                        'item' => 'get_member_mini_qr',
                                        'parents' => ['Member', 'member_all', 'member_detail'],
                                    ],
                                    'change_member_password' => [
                                        'name' => '修改密码',
                                        'url' => 'member.member.change-password',
                                        'url_params' => '',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'icon' => '',
                                        'sort' => 0,
                                        'item' => 'change_member_password',
                                    ],
                                    'change_mobile_log' => [
                                        'name' => '修改绑定手机号记录',
                                    ...
                                    'change_address' => [
                                        'name' => '更新地址',
                                        'url' => 'member.member.address-update',
                                        'url_params' => '',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'icon' => '',
                    ...
                    'member_verify_auth_manage' => [
                        'name' => '实名认证管理',
                        'url' => 'member.member-auth.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-sort-alpha-asc',
                        'sort' => 0,
                        'item' => 'member_verify_auth_manage',
                        'parents' => ['Member'],
                        'child' => [
                            'member_auth_verify' => [
                                'name' => '实名认证申请列表',
                                ...
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'member_auth_verify',
                                'parents' => ['Member', 'member_verify_auth_manage'],
                            ],
                            'member_auth_verify_detail' => [
                                'name' => '审核详情',
                                'url' => 'member.member-auth.detail',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => 'fa-circle-o',
                                'sort' => 0,
                                'item' => 'member_auth_verify_detail',
                                'parents' => ['Member','member_verify_auth_manage'],
                            ],
                            'member_auth_verify_pass' => [
                                'name' => '通过驳回审核',
                                'url' => 'member.member-auth.pass',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => 'fa-circle-o',
                                'sort' => 0,
                                'item' => 'member_auth_verify_pass',
                                'parents' => ['Member', 'member_verify_auth_manage'],
                            ],
                    ...
                    'company_auth_manage' => [
                        'name' => '企业认证管理',
                        'url' => 'member.company-auth.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-sort-alpha-asc',
                        'sort' => 0,
                        'item' => 'company_auth_manage',
                        'parents' => ['Member'],
                        'child' => [
                            'company_auth_verify' => [
                                'name' => '企业认证申请列表',
                                ...
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'company_auth_verify',
                                'parents' => ['Member', 'company_auth_manage'],
                            ],
                            'company_auth_verify_detail' => [
                                'name' => '审核详情',
                                'url' => 'member.company-auth.detail',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => 'fa-circle-o',
                                'sort' => 0,
                                'item' => 'company_auth_verify_detail',
                                'parents' => ['Member','company_auth_manage'],
                            ],
                            'company_auth_verify_pass' => [
                                'name' => '通过驳回审核',
                                'url' => 'member.company-auth.pass',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => 'fa-circle-o',
                                'sort' => 0,
                                'item' => 'company_auth_verify_pass',
                                'parents' => ['Member', 'company_auth_manage'],
                            ],
                    ...
                    'invitation_auth_manage' => [
                        'name' => '邀请码管理',
                        'url' => 'member.invitation.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-sort-alpha-asc',
                        'sort' => 0,
                        'item' => 'invitation_auth_manage',
                        'parents' => ['Member'],
                        'child' => [
                            'invitation_auth_list' => [
                                'name' => '邀请码列表',
                                'url' => 'member.invitation.index',
                                'url_params' => '',
                                'permit' => 1,
                                ...
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'invitation_auth_list',
                                'parents' => ['Member', 'invitation_auth_manage'],
                            ],
                            'invitation_auth_detail' => [
                                'name' => '邀请码新增',
                                'url' => 'member.invitation.create',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => 'fa-circle-o',
                                'sort' => 0,
                                'item' => 'invitation_auth_detail',
                                'parents' => ['Member','invitation_auth_manage'],
                            ],
                            'invitation_auth_delete' => [
                                'name' => '邀请码删除',
                                'url' => 'member.invitation.destroy',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => 'fa-circle-o',
                                'sort' => 0,
                                'item' => 'invitation_auth_delete',
                                'parents' => ['Member', 'invitation_auth_manage'],
                            ],

                            'invitation_auth_status' => [
                                'name' => '邀请码删除',
                                ...
                                'icon' => 'fa-circle-o',
                                'sort' => 0,
                                'item' => 'invitation_auth_status',
                                'parents' => ['Member', 'invitation_auth_manage'],
                            ],
                            'invitation_shareQrCode' => [
                                'name' => '邀请码分享',
                                'url' => 'member.invitation.shareQrCode',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => 'fa-circle-o',
                                'sort' => 0,
                                'item' => 'invitation_shareQrCode',
                                'parents' => ['Member', 'invitation_auth_manage'],
                            ],
            ...
            'Order' => [
                'name' => '订单',
                'url' => 'order.purchase-order.index',
                'url_params' => '',
                'permit' => 1,
                'menu' => 1,
                'top_show' => 0,
                ...
                'child' => [
                    'order_vue_operation' => [
                        ...
                        'child' => [
                            ...
                            'order_vue-operation_update_logistics' => [
                                'name' => '修改物流',
                                'url' => 'order.vue-operation.update-logistics',
                                'permit' => 1,
                                'menu' => 0,
                                'item' => 'operation_update_logistics',
                                'parents' => ['Order', 'order_vue_operation'],
                            ],
                            'order_multiple_packages_order_goods_order_express' => [
                                'name' => '获取修改包裹',
                                'url' => 'order.multiple-packages-order-goods.order-express',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'item' => 'order_multiple_packages_order_goods_order_express',
                                'parents' => ['Order', 'order_vue_operation'],
                            ],
                        ...
                        'child' => [
                            ...
                            'shop_order_list' => [
                                ...
                                'child' => [
                                    ...
                                    'shop_order_export' => [
                                        'name' => '平台订单列表导出',
                                        'url' => 'order.shop-order-list.shop-export',
                                        'permit' => 0,
                    ...
                    'purchase_order_list' => [
                        ...
                        'icon' => 'fa-clipboard',
                        'sort' => 0,
                        'item' => 'purchase_order_list',
                        'parents' => ['Order'],
                        'child' => [

                            'shop_purchase_order_list' => [
                                'name' => '采购订单列表',
                                'url' => 'order.purchase-order.getData',
                                'permit' => 1,
                                'sort' => 1,
                                'item' => 'shop_purchase_order_list',
                                'parents' => ['Order','purchase_order_list'],
                                'child' => [],
                            ],

                            'shop_purchase_order_detail' => [
                                'name' => '采购订单详情',
                                'url' => 'order.purchase-order.detail',
                                'permit' => 1,
                                'sort' => 1,
                                'item' => 'shop_purchase_order_detail',
                                'parents' => ['Order','purchase_order_list'],
                                'child' => [],
                            ],

                            'shop_purchase_order_list_detail' => [
                                'name' => '查看详情清单',
                                'url' => 'order.purchase-order.getDetailList',
                                'permit' => 1,
                                'sort' => 1,
                                'item' => 'shop_purchase_order_list_detail',
                                'parents' => ['Order','purchase_order_list'],
                                'child' => [],
                            ],
                    ...
                    'bid_order_list' => [
                        ...
                        'child' => [
                            ...
                            'shop_bid_order_list' => [
                                'name' => '投标订单列表',
                                'url' => 'order.bid-order.getData',
                                'permit' => 1,
                                'sort' => 1,
                                'item' => 'shop_bid_order_list',
                                'parents' => ['Order','bid_order_list'],
                                'child' => [],
                            ],

                            'shop_bid_order_detail' => [
                                'name' => '投标订单详情',
                                'url' => 'order.bid-order.detail',
                                'permit' => 1,
                                'sort' => 1,
                                'item' => 'shop_bid_order_detail',
                                'parents' => ['Order','bid_order_list'],
                                'child' => [],
                            ],
                    ...
                    'door_order_list' => [
                        'name' => '上门订单',
                        'url' => 'order.door-order.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-clipboard',
                        'sort' => 0,
                        'item' => 'door_order_list',
                        'parents' => ['Order'],
                        'child' => [

                            'shop_door_order_list' => [
                                'name' => '上门订单列表',
                                'url' => 'order.door-order.getData',
                                'permit' => 1,
                                'sort' => 1,
                                'item' => 'shop_door_order_list',
                                'parents' => ['Order','door_order_list'],
                                'child' => [],
                            ],

                            'shop_door_order_detail' => [
                                'name' => '投标订单详情',
                                'url' => 'order.door-order.detail',
                                'permit' => 1,
                                'sort' => 1,
                                'item' => 'shop_door_order_detail',
                                'parents' => ['Order','door_order_list'],
                                'child' => [],
                            ],
...
//                                    ],
                                    ...
                                    'refund_vue_operation_batch_resend' => [
                                        'name' => '商家分批重新发货',
                                        'url' => 'refund.vue-operation.batch-resend',
                                        'url_params' => '',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'sort' => '4',
                                    ...
                                    'refund_vue_operation_after_sales.supplier_detail' => [
                                        'name' => '供应商退款详情',
                                        'url' => 'refund.after-sales.supplier_detail',
                                        'url_params' => '',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'sort' => '4',
                                        'item' => 'refund_vue_operation_after_sales.supplier_detail',
                                        'parents' => ['Order', 'refund_list_refund'],
                                    ],
                                ],
                            ],
            ...
            'finance' => [
                ...
                'child' => [
                    ...
                    'finance_order_list' => [
                        ...
                        'icon' => 'fa-file-text-o',
                        'sort' => 0,
                        'item' => 'finance_order_list',
                        'parents' => ['finance'],
                        'child' => [

                            'finance_order_getdata' => [
                                'name' => '订单列表',
                                'url' => 'finance.order.getData',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_getdata',
                                'parents' => ['finance', 'finance_order_list'],
                            ],
                            'finance_order_getCredentials' => [
                                'name' => '获取凭证',
                                'url' => 'finance.order.getCredentials',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_getCredentials',
                                'parents' => ['finance', 'finance_order_getCredentials'],
                            ],
                            'finance_order_detail' => [
                                'name' => '详情',
                                'url' => 'finance.order.detail',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_detail',
                                'parents' => ['finance', 'finance_order_list'],
                            ],
                            'finance_order_confirmPay' => [
                                'name' => '确认付款',
                                'url' => 'finance.order.confirmPay',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_confirmPay',
                                'parents' => ['finance', 'finance_order_confirmPay'],
                            ],
                            'finance_order_getVoucher' => [
                                'name' => '获取凭证',
                                'url' => 'finance.order.getVoucher',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_getVoucher',
                                'parents' => ['finance', 'finance_order_getVoucher'],
                            ],
                            'finance_order_confirmLogisticPay' => [
                                'name' => '确认物流支付',
                                'url' => 'finance.order.confirmLogisticPay',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_confirmLogisticPay',
                                'parents' => ['finance', 'finance_order_getVoucher'],
                            ],
                            'finance_order_revokeLogisticPay' => [
                                'name' => '撤销物流支付',
                                'url' => 'finance.order.revokeLogisticPay',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_revokeLogisticPay',
                                'parents' => ['finance', 'finance_order_revokeLogisticPay'],
                            ],
                            'finance_order_getLogisticVoucher' => [
                                'name' => '获取物流凭证',
                                'url' => 'finance.order.getLogisticVoucher',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_getLogisticVoucher',
                                'parents' => ['finance', 'finance_order_getLogisticVoucher'],
                            ],
                            'finance_order_confirmInstallPay' => [
                                'name' => '确定安装支付',
                                'url' => 'finance.order.confirmInstallPay',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_confirmInstallPay',
                                'parents' => ['finance', 'finance_order_confirmInstallPay'],
                            ],
                            'finance_order_revokeInstallPay' => [
                                'name' => '撤销安装支付',
                                'url' => 'finance.order.revokeInstallPay',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_revokeInstallPay',
                                'parents' => ['finance', 'finance_order_revokeInstallPay'],
                            ],
                            'finance_order_getInstallVoucher' => [
                                'name' => '获取安装凭证',
                                'url' => 'finance.order.getInstallVoucher',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_getInstallVoucher',
                                'parents' => ['finance', 'finance_order_getInstallVoucher'],
                            ],
                            'finance_order_getSignVoucher' => [
                                'name' => '获取验证凭证',
                                'url' => 'finance.order.getSignVoucher',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_order_getSignVoucher',
                                'parents' => ['finance', 'finance_order_getSignVoucher'],
                            ],

                        ]
                    ],
                   /* 'finance_after_sales_order_list' => [
                        'name' => '售后订单',
                        'url' => 'finance.after-order.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-file-text-o',
                        'sort' => 0,
                        'item' => 'finance_after_sales_order_list',
                        'parents' => ['finance'],
                        'child' => [
                    ...
                    'bid_order_manage_list' => [
                        'name' => '投标订单',
                        'url' => 'finance.bid-order.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-file-text-o',
                        'sort' => 0,
                        'item' => 'bid_order_manage_list',
                        'parents' => ['finance'],
                        'child' => [
                            'finance_bid_order_get_data' => [
                                'name' => '获取列表',
                                'url' => 'finance.bid-order.getData',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_bid_order_get_data',
                                'parents' => ['finance', 'bid_order_manage_list'],
                            ],
                            'finance_bid_order_detail' => [
                                'name' => '查看详情',
                                'url' => 'finance.bid-order.detail',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_bid_order_detail',
                                'parents' => ['finance', 'bid_order_manage_list'],
                            ],
                    ...
                    'door_order_manage_list' => [
                        'name' => '上门订单',
                        'url' => 'finance.door-order.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-file-text-o',
                        'sort' => 0,
                        'item' => 'door_order_manage_list',
                        'parents' => ['finance'],
                        'child' => [
                            'finance_door_order_get_data' => [
                                'name' => '获取列表',
                                'url' => 'finance.door-order.getData',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_door_order_get_data',
                                'parents' => ['finance', 'door_order_manage_list'],
                            ],
                            'finance_door_order_detail' => [
                                'name' => '查看详情',
                                'url' => 'finance.door-order.detail',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_door_order_detail',
                                'parents' => ['finance', 'door_order_manage_list'],
                            ],
                    ...
                    'finance_invoice_order_list' => [
                        'name' => '开票订单',
                        'url' => 'finance.invonice-order.index',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-file-text-o',
                        'sort' => 0,
                        'item' => 'finance_invoice_order_list',
                        'parents' => ['finance'],
                        'child' => [
                            'finance_invoice_get_data' => [
                                'name' => '获取列表',
                                'url' => 'finance.invonice-order.getData',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_invoice_get_data',
                                'parents' => ['finance', 'finance_invoice_order_list'],
                            ],
                            'finance_invoice_getOrderInvoiceInfo' => [
                                'name' => '获取发票上传',
                                'url' => 'finance.invonice-order.getOrderInvoiceInfo',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_invoice_getOrderInvoiceInfo',
                                'parents' => ['finance', 'finance_invoice_order_list'],
                            ],
                            'finance_invoice_uploadInvonice' => [
                                'name' => '上传发票',
                                'url' => 'finance.invonice-order.uploadInvonice',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_invoice_uploadInvonice',
                                'parents' => ['finance', 'finance_invoice_order_list'],
                            ],
                            'finance_invoice_detail' => [
                                'name' => '上传发票',
                                'url' => 'finance.InvoniceOrder.detail',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'finance_invoice_detail',
                                'parents' => ['finance', 'finance_invoice_order_list'],
                            ],
                        ]
                    ],
                    ...
                    'transaction_detail' => [
                        ...
                        'child' => [
                            'transaction_detail_index' => [
                                'name' => '交易记录列表',
                                'url' => 'finance.trade.getData',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => 'fa-gear',
                                'sort' => 0,
                                'item' => 'transaction_detail_index',
                                'parents' => ['finance', 'transaction_detail'],
                            ],
                            'transaction_detail_detail' => [
                                'name' => '交易记录详细',
                                ...
                                'icon' => 'fa-gear',
                                'sort' => 0,
                                'item' => 'transaction_detail_detail',
                                'parents' => ['finance', 'transaction_detail'],
                            ],
                            'transaction_detail_paylist' => [
                                'name' => '交易记录',
                                'url' => 'finance.trade.getPayList',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'icon' => 'fa-gear',
            ...
            'project_manage' => [
                'name' => '项目管理',
                'url' => 'project.report-project.index',
                'url_params' => '',
                'permit' => 1,
                'menu' => 1,
                'top_show' => 0,
                ...
                'child' => [
                    ...
                    'report_project_manage' => [
                        ...
                        'icon' => 'fa-cubes',
                        'sort' => 0,
                        'item' => 'report_project_manage',
                        'parents' => ['project_manage'],
                        'child' => [

                            'report_project_manage_detail' => [
                                'name' => '报备详情',
                                'url' => 'project.report-project.detail',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'report_project_manage_detail',
                                'parents' => ['project_manage', 'report_project_manage'],
                            ],
                        ],
                    ],
                    ...
                    'bid_project_manage' => [
                        ...
                        'icon' => 'fa-cubes',
                        'sort' => 0,
                        'item' => 'bid_project_manage',
                        'parents' => ['project_manage'],
                        'child' => [

                            'bid_project_manage_detail' => [
                                'name' => '投标详情',
                                'url' => 'project.bid-project.detail',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'bid_project_manage_detail',
                                'parents' => ['project_manage', 'bid_project_manage'],
                            ],
                        ],
                    ],

                    'factory_inspection_manage' => [
                        'name' => '考察管理',
                        'url' => 'project.factory-inspection.index',
                        'url_params' => '',
                        'permit' => 1,
                        'style' => 'pulish',
                        'menu' => 1,
                        'icon' => 'fa-cubes',
                        'sort' => 0,
                        'item' => 'factory_inspection_manage',
                        'parents' => ['project_manage'],
                        'child' => [

                            'factory_inspection_manage_detail' => [
                                'name' => '考察详情',
                                'url' => 'project.factory-inspection.detail',
                                'url_params' => '',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'sort' => 0,
                                'item' => 'factory_inspection_manage_detail',
                                'parents' => ['project_manage', 'factory_inspection_manage'],
                            ],
                        ],
                    ],
...
//                            ],
                            ...
                            'setting_yun_open' => [
                                'name' => '云API',
                                'url' => 'setting.yun-open.index',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 1,
                                'icon' => '',
                                'sort' => '7',
                                'item' => 'setting_yun_open',
                                'parents' => ['system', 'Setting', 'setting_shop'],
                                'child' => [
                                    'setting_yun_open_save' => [
                                        'name' => '保存',
                                        'url' => 'setting.yun-open.index.save',
                                        'permit' => 1,
                                        'menu' => 0,
                                        'icon' => '',
                                        'item' => 'setting_yun_open_save',
                                        'parents' => ['system', 'Setting', 'setting_shop', 'setting_yun_open'],
                                    ],
                                ]
                            ],
                    ...
                    'setting_pay_manage' => [
                        ...
                        'icon' => 'fa-credit-card',
                        'sort' => '3',
                        'item' => 'setting_pay_manage',
                        'parents' => ['system'],
                        'child' => [
                            'setting_pay_manage_index' => [
                                'name' => '商城支付方式管理',
                                'url' => 'setting.payment-manage.index',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'item' => 'setting_pay_manage_payWidget',
                                'parents' => ['system', 'setting_pay_manage'],
                            ],
                            'setting_pay_manage_payWidget' => [
                                'name' => '获取商城开启的支付方式',
                                'url' => 'setting.payment-manage.pay-widget',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'item' => 'setting_pay_manage_payWidget',
                            ...
                            'setting_pay_manage_submitSave' => [
                                'name' => '支付方式设置保存',
                                'url' => 'setting.payment-manage.submit-save',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'item' => 'setting_pay_manage_submitSave',
                                'parents' => ['system', 'setting_pay_manage'],
                            ],
                        ],
                    ],
                    'setting_pay_manage_integration_pay' => [
                        'name' => '聚合支付操作',
                        'url' => 'setting.integration-pay.updPayAccount',
                        'permit' => 0,
                        'menu' => 0,
                        'icon' => 'fa-credit-card',
                        'sort' => '3',
                        'item' => 'setting_pay_manage_integration_pay',
                        'parents' => ['system'],
                        'child' => [
                            'integration_pay_withdraw' => [
                                'name' => '拉卡拉钱包提现',
                                'url' => 'setting.integration-pay.withdraw',
                                'permit' => 0,
                                'menu' => 0,
                                'item' => 'integration_pay_withdraw',
                                'parents' => ['system', 'setting_pay_manage_integration_pay'],
                            ],
                            'integration_pay_pre-withdraw' => [
                                'name' => '拉卡拉钱包提现准备',
                                'url' => 'setting.integration-pay.pre-withdraw',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'item' => 'integration_pay_withdrawLog',
                                'parents' => ['system', 'setting_pay_manage_integration_pay'],
                            ],
                            'integration_pay_withdrawLog' => [
                                'name' => '拉卡拉钱包提现记录',
                                'url' => 'setting.integration-pay.withdrawLog',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'item' => 'integration_pay_withdrawLog',
                            ...
                            'integration_pay_withdrawList' => [
                                'name' => '拉卡拉钱包提现记录列表',
                                'url' => 'setting.integration-pay.withdrawList',
                                'permit' => 0,
                                'menu' => 0,
                                'icon' => '',
                                'item' => 'integration_pay_withdrawList',
                                'parents' => ['system', 'setting_pay_manage_integration_pay'],
                            ],
                        ],
                    ],
...
//                    ],
            ...
            'component_white_list' => [
                ...
                'left_second_show' => 0,
                'parents' => [],
                'item' => 'component_white_list',
                'child' => [
                    'component_get_shop_jump_link' => [
                        'name' => '商城页面跳转链接',
                        'url' => 'component.get-jump-link',
                        'url_params' => '',
                        'permit' => 0,
                        'menu' => 0,
                        'icon' => '',
                        'sort' => '4',
                        'item' => 'component_get_shop_jump_link',
                        'parents' => ['component_white_list'],
                        'child' => []
                    ],
                    'component_get_shop_category' => [
                        'name' => '获取商城分类',
                        'url' => 'link.link.categoryLink',
                        'url_params' => '',
                        'permit' => 0,
                        'menu' => 0,
                        'icon' => '',
                        'sort' => '4',
                        'item' => 'component_get_shop_category',
                        'parents' => ['component_white_list'],
                        'child' => []
                    ],
                    'component_get_brand' => [
                        'name' => '获取商城品牌',
                        'url' => 'link.link.brandLink',
                        'url_params' => '',
                        'permit' => 0,
                        'menu' => 0,
                        'icon' => '',
                        'sort' => '4',
                        'item' => 'component_get_brand',
                        'parents' => ['component_white_list'],
                        'child' => []
                    ],
                    'component_get_mini_link_goods' => [
                        'name' => '获取小程序商品信息',
                        'url' => 'goods.goods.getSmallMyLinkGoods',
                        'url_params' => '',
                        'permit' => 0,
                        'menu' => 0,
                        'icon' => '',
                        'sort' => '4',
                        'item' => 'component_get_mini_link_goods',
                        'parents' => ['component_white_list'],
                        'child' => []
                    ],
                    'component_get_mini_link_brand' => [
                        'name' => '获取小程序品牌信息',
                        'url' => 'link.link.smallProceduresBrandLink',
                        'url_params' => '',
                        'permit' => 0,
                        'menu' => 0,
                        'icon' => '',
                        'sort' => '4',
                        'item' => 'component_get_mini_link_brand',
                        'parents' => ['component_white_list'],
                        'child' => []
                    ],
                ],
            ...
            /*'export' => [
                ...
                'child' => [
                    ...
                    'export_index_get_list' => [
                        'name' => '获取导出列表',
                        'url' => 'export.index.get-list',
                        'url_params' => '',
                        'permit' => 0,
                        'menu' => 0,
                        'icon' => 'fa-hand-o-right',
                    ...
                    'export_index_download' => [
                        'name' => '导出下载',
                        'url' => 'export.index.download',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 0,
                        'icon' => 'fa-hand-o-right',
                    ...
                    'export_template_get_list' => [
                        'name' => '获取导出模板',
                        'url' => 'export.template.get-list',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 0,
                        'icon' => 'fa-hand-o-right',
                    ...
                    'export_template_get_columns' => [
                        'name' => '获取模板信息',
                        'url' => 'export.template.get-columns',
                        'url_params' => '',
                        'permit' => 0,
                        'menu' => 0,
                        'icon' => 'fa-hand-o-right',
                    ...
                    'export_template_get_detail' => [
                        'name' => '获取模板详情',
                        'url' => 'export.template.get-detail',
                        'url_params' => '',
                        'permit' => 0,
                        'menu' => 0,
                        'icon' => 'fa-hand-o-right',
        ...
        return [
            ...
            'site_setting' => [
                ...
                'child' => [
                    ...
                    'site_setting.domain' => [
                        'name' => '域名替换',
                        'url' => 'siteSetting.index.domain',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-bell-o',
                        'sort' => '7',
                        'item' => 'setting_shop_domain',
                        'parents' => ['system', 'site_setting', 'system_site_setting_domain_index'],
                    ],
...
//                        'menu'       => $is_platfrom,
                    ...
                    'site_setting.mqttConfig' => [
                        'name' => 'MQTT设置',
                        'url' => 'siteSetting.index.mqtt-config',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => '',
                        'sort' => '1',
                        'item' => 'setting_shop_mqtt_config',
                        'parents' => ['system', 'site_setting'],
                        'child' => [
                            'site_setting.mqttConfig_save' => [
                                'name' => 'MQTT设置保存',
                                'url' => 'siteSetting.store.mqtt',
                                'url_params' => '',
                                'permit' => 0,
                                'parents' => ['system', 'site_setting'],
                            ]
                    ...
                    'site_setting.yz_supply_message_config' => [
                        'name' => '中台消息设置',
                        'url' => 'siteSetting.index.yz-supply-message-config',
                        'url_params' => '',
                        'permit' => 1,
//                        'menu'       => $is_platfrom,
                        'menu' => 1,
                    ...
                    'website_log_setting' => [
                        'name' => '应用日志',
                        'url' => 'setting.shop.website-log',
                        'url_params' => '',
                        'permit' => 1,
                        'menu' => 1,
                        'icon' => 'fa-link',
                        'sort' => '5',
                        'item' => 'website_log_setting',
                        'parents' => ['system', 'site_setting'],
                        'child' => [
                            'website_log_setting_delete' => [
                                'name' => '删除日志',
                                'url' => 'setting.shop.website-log-delete',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'item' => 'website_log_setting_delete',
                                'parents' => ['system', 'site_setting', 'website_log_setting'],
                            ],
                            'website_log_setting_save' => [
                                'name' => '保存设置',
                                'url' => 'setting.shop.website-log-save',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'item' => 'website_log_setting_save',
                                'parents' => ['system', 'site_setting', 'website_log_setting'],
                            ],
                        ]
                    ],
                    'refresh_cdn' => [
                        ...
                        'child' => [
                            'refresh_cdn_save' => [
                                'name' => '刷新cdn请求',
                                'url' => 'setting.shop.postCdn',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'item' => 'refresh_cdn_save',
                                'parents' => ['system', 'site_setting', 'refresh_cdn'],
                            ],
                            'refresh_cdn_reload' => [
                                'name' => '刷新cdn列表',
                                'url' => 'setting.shop.getCdn',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'item' => 'refresh_cdn_reload',
                                'parents' => ['system', 'site_setting', 'refresh_cdn'],
                            ],
                            'refresh_cdn_data_save' => [
                                'name' => '保存cdn数据',
                                'url' => 'setting.shop.saveCndData',
                                'url_params' => '',
                                'permit' => 1,
                                'menu' => 0,
                                'item' => 'refresh_cdn_data_save',
                                'parents' => ['system', 'site_setting', 'refresh_cdn'],
                            ],
                        ]
                    ],
