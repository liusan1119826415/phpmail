...
class Supervisor
{
    ...
    {
        //删除hosts
        \Illuminate\Support\Facades\Redis::expire('hosts',-1);
        foreach (\Illuminate\Support\Facades\Redis::keys('forkPids:*') as $forkPid) {
            \Illuminate\Support\Facades\Redis::expire($forkPid,-1);
        }
