...
class GoodsOption extends \app\common\models\BaseModel
{
    ...
    public function hasManyOptionModels()
    {
        return $this->hasMany(GoodsOptionModel::class, 'option_id');
    }
    ...
    public function getPointsAttribute()
    {
        ...
        return $tradeGoodsPointsServer->getPoint($points, $this->product_price, $this->cost_price, $this->goods_id, $this->id);
    }
...
//                }
    ...
    public function getNextVipNameAttribute()
    {
