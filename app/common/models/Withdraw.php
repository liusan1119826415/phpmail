...
class Withdraw extends BaseModel
{
    ...
    /**
     * 提现打款方式：打款到耕耘灵活用工-银行卡
     */
    const CONSOL_WITHDRAW_BANK = 'consol_withdraw_bank';

    /**
     * 提现打款方式：打款到耕耘灵活用工-支付宝
     */
    const CONSOL_WITHDRAW_ALIPAY = 'consol_withdraw_alipay';

    /**
     * 提现打款方式：打款到耕耘灵活用工-微信
     */
    const CONSOL_WITHDRAW_WECHAT = 'consol_withdraw_wechat';

    const HUIIS_ALI = 'huiis_ali';
    const HUIIS_WX = 'huiis_wx';
    const HUIIS_BANK = 'huiis_bank';

    const GONG_MALL_WITHDRAW_ALI = 'gong_mall_withdraw_ali';
    const GONG_MALL_WITHDRAW_BANK = 'gong_mall_withdraw_bank';

    const INTEGRATION_PAY_SHARE_HUIFU_WITHDRAW_BANK = 'integration_pay_share_huifu_withdraw_bank';

    const RENLIJIA_WITHDRAW = 'renlijia_withdraw';

    const HEMA_WITHDRAW_BANK='hema_withdraw_bank';
    ...
    public static $payWayComment = [
        ...
        self::CONSOL_WITHDRAW_BANK => '提现到耕耘灵活用工-银行卡',
        self::CONSOL_WITHDRAW_ALIPAY => '提现到耕耘灵活用工-支付宝',
        self::CONSOL_WITHDRAW_WECHAT => '提现到耕耘灵活用工-微信',
        self::HUIIS_ALI => '提现到支付宝-云汇算',
        self::HUIIS_WX => '提现到微信-云汇算',
        self::HUIIS_BANK => '提现到银行卡-云汇算',
        self::GONG_MALL_WITHDRAW_BANK => '提现到银行卡-工猫',
        self::GONG_MALL_WITHDRAW_ALI => '提现到支付宝-工猫',
        self::INTEGRATION_PAY_SHARE_HUIFU_WITHDRAW_BANK => '提现到银行卡-汇付',
        self::RENLIJIA_WITHDRAW => '提现到银行卡-人力家',

        self::HEMA_WITHDRAW_BANK => '提现到银行卡-杉德宝',
    ];
    ...
    public static function getPayWayComment($pay_way)
    {
        ...
        static::$payWayComment[self::WITHDRAW_WITH_BALANCE] = '提现到' . ($lang['credit'] ?: '余额');
