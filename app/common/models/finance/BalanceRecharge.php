...
class BalanceRecharge extends BaseModel
{
    ...
    {
        return $this->hasOne(BalanceRechargeRequest::class,'recharge_id','id');
    }

    //优惠
    public function discounts()
    {
        return $this->hasMany(BalanceRechargeDiscountLog::class,'recharge_id','id');
    }
