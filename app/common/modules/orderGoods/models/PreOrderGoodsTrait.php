...
trait PreOrderGoodsTrait
{
    ...
    public function getPreAttributes()
    {
        $attributes = array(
            ...
            'price' => $this->getPrice(),
          //  'goods_cost_price' => $this->getGoodsUnitPrice(),
        ...
        if ($this->isOption()) {
            ...
            $attributes += [
                ...
                'goods_cost_price'=>$this->goodsOption->product_price
            ];
        }
    ...
    {
        print_r($this->getPriceCalculator()->getGoodsUnitPrice());die;
        return $this->getPriceCalculator()->getGoodsUnitPrice();
    }
