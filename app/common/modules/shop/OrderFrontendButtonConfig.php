...
use app\frontend\modules\order\operations\member\ChangePrice;
    ...
    protected function _getItems()
    {
        $result = [
            'member_order_operations' => [
                'waitPay' => [
                    \app\frontend\modules\order\operations\member\CheckPay::class,
                    \app\frontend\modules\order\operations\member\Pay::class,
                    \app\frontend\modules\order\operations\member\Detail::class,
                ...
                'close' => [
                 //   \app\frontend\modules\order\operations\member\ExpressInfo::class,
                  ...
                  //  \app\frontend\modules\order\operations\member\CloseReason::class,
                    \app\frontend\modules\order\operations\member\Delete::class,
                   // \app\frontend\modules\order\operations\member\Restore::class,
                ],
                //待确认
                'confirm' => [
                    \app\frontend\modules\order\operations\member\Viewdraw::class,
                    \app\frontend\modules\order\operations\member\Detail::class,
                    \app\frontend\modules\order\operations\member\Close::class,

                ],
                'product' => [
                    \app\frontend\modules\order\operations\member\Product::class,
                    \app\frontend\modules\order\operations\member\ApplyRefund::class,
                    \app\frontend\modules\order\operations\member\Refunding::class,
                    \app\frontend\modules\order\operations\member\Detail::class,
                ],
                ...
                'waitPay2' =>[
                    ...
                    \app\frontend\modules\order\operations\member\Pay::class,
                    \app\frontend\modules\order\operations\member\Detail::class,
                    \app\frontend\modules\order\operations\member\Added::class,
                    \app\frontend\modules\order\operations\member\ApplyRefund::class,
                ],
                'completeV2' => [
                    \app\frontend\modules\order\operations\member\Added::class,
