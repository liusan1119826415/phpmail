        ...
        $result = [
            ...
            'observer' => [
                'goods' => [
                    ...
                    'image_link' => [
                        'class' => 'app\common\models\goods\ImageLink',
                        'function_validator' => 'relationValidator',
                        'function_save' => 'relationSave'
                    ],
                ],
            ...
            'shop-foundation' => [
                'balance' => [
                    'recharge-page' => [
                        \app\frontend\modules\finance\balance\RechargePageConfig::class,
                    ],
                ],
                'pay-page' => [
                    'type' => [
                        ['code' => 'shop', 'priority' => 0,
                            'config' => '',
                            'class' => function (\app\common\models\Order $order) {
                                return new \app\frontend\modules\payment\services\page\ShopPaymentPage($order);
                            },
                        ]
                    ],
                    'reward' => [
                        [
                            ...
                            'class' => function (\app\frontend\modules\payment\services\page\PaymentPageInterface $page) {
                                return new \app\frontend\modules\payment\services\page\reward\BalancePayPageReward($page);
                            },
                        ],
                        [
                            'code' => 'point',
                            'class' => function (\app\frontend\modules\payment\services\page\PaymentPageInterface $page) {
                                return new \app\frontend\modules\payment\services\page\reward\PointPayPageReward($page);
                            },
                        ],
                        [
                            'code' => 'share_coupon',
                            'class' => function (\app\frontend\modules\payment\services\page\PaymentPageInterface $page) {
                                return new \app\frontend\modules\payment\services\page\reward\ShareCouponPayPageReward($page);
                            },
                        ],
                        [
                            'code' => 'coupon',
                            'class' => function (\app\frontend\modules\payment\services\page\PaymentPageInterface $page) {
                                return new \app\frontend\modules\payment\services\page\reward\CouponPayPageReward($page);
                            },
                        ],
                    ],
                ],
                'goods' => [
                    ...
                    'plugin'    => [0],
                    //下单不会扣除库存的订单类型128 = 圈仓插件,56 = 云仓插件
                    'no-deduct-stock' => [56,128],
                    //下单不会扣除库存的验证，例子:agency插件
                    'no-deduct-stock-class' => [],
                ],
                //订单列表类型区分
                'order-list' => [
                    'type' => [
...
//                    ],
                ...
                'goods-discount-after-deduction' => [],
                'coin-exchange' => [
...
//                        },
//                    ]
                ], 'order-discount-after-deduction' => [
