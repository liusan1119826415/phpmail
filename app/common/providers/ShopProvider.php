...
use app\common\services\asset\ShopAsset;
...
use app\frontend\modules\withdraw\services\WithdrawButtonManager;
...
class ShopProvider extends ServiceProvider
{
    public function register()
    {
        ...
        $this->app->singleton('ShopAsset', function () {
            return new ShopAsset();
        });

        $this->app->singleton('WithdrawButton',function () {
            return new WithdrawButtonManager();
        });
