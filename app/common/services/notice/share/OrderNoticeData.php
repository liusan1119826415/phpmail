...
Trait OrderNoticeData
{
    ...
    public function processData($order)
    {
        ...
        $this->timeData = [
            ...
            'pay_time' => $order->pay_time?$order->pay_time->toDateTimeString():"",
            'finish_time' => $order->finish_time?$order->finish_time->toDateTimeString():"",
            'cancel_time' => $order->cancel_time?$order->cancel_time->toDateTimeString():"",
            'send_time' => $order->send_time?$order->send_time->toDateTimeString():""
        ];
