...
class EncryptUtil
{
     ...
     * @param string $data
     * @param string $private_content
     * @param integer $signature_alg 签名算法：默认MD5、RSA2 = OPENSSL_ALGO_SHA256
     * @return array
     */
    public static function sign($data, $private_content, $signature_alg = OPENSSL_ALGO_MD5)
    {
        ...
        $binary_signature = '';
        $isSuccess = openssl_sign($data, $binary_signature, $priKey, $signature_alg);
        openssl_free_key($priKey);
     ...
     * @return array
     */
    public static function verify($signData, $signParam, $public_content, $signature_alg = OPENSSL_ALGO_MD5)
    {
        ...
        $isMatch = openssl_verify($signData, $signParam, $pubKey, $signature_alg) === 1;
        openssl_free_key($pubKey);
