...
*/
    ...
    public function getMemberProtocol(Request $request,$integrated = null)
    {
        ...
        if ($shop['is_legal']){
            $data['legal_notice'] = RichText::get('shop.legal_notice');
            $data['legal_name'] = $shop['legal_name'];
        }
    ...
    public function getBalance()
    {
        ...
        $credit=$lang['member_center']['credit'] ?: '余额';
    ...
    public function getRegisterDiyForm(Request $request, $integrated = null)
    {
        ...
        if ($is_diyform) {
			...
			$data['form_id_register'] = $member_set['form_id_register'];
