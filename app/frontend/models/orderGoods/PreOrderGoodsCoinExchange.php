...
class PreOrderGoodsCoinExchange extends OrderGoodsCoinExchange
{
    ...
    {
        $this->getMemberCoin()->consume($this->newCoin()->setCoin($this->coin), ['order_sn' => $this->orderGoods->order->order_sn,'order_id' => $this->orderGoods->order->id,'deduction' => $this->orderGoods->getGoodsPrice()]);
