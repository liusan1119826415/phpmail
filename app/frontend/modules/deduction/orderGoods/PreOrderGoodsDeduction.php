...
//        }
        ...
        switch ($this->getOrderDeduction()->getDeduction()->getAffectDeductionAmount()) {
            case 'integer'://金额整数抵扣
                $amountHandle = new \app\frontend\modules\deduction\amount\IntegerOrderDeductionAmount($this->getOrderDeduction(),$amount);
                break;
            case 'coin_integer'://虚拟币整数抵扣
                $amountHandle = new \app\frontend\modules\deduction\amount\CoinIntegerOrderDeductionAmount($this->getOrderDeduction(),$amount);
                break;
            default:
                $amountHandle = new \app\frontend\modules\deduction\amount\OrderDeductionAmount($this->getOrderDeduction(),$amount);
                break;
        }
