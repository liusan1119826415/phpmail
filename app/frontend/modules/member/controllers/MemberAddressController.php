...
class MemberAddressController extends ApiController
{
    ...
    /**
     * @var \app\frontend\modules\member\models\YzMemberAddress|\app\frontend\modules\member\models\MemberAddress
     */
    ...
    public function page()
    {
        ...
        $addressList = $this->memberAddressRepository->getStaticModel()
            ->uniacid()->where('uid', $memberId)->orderBy('id', 'desc')->paginate(20);
        ...
        return $this->successJson('会员地址列表', $addressList);
    }
...
//        dd($addressList);
    ...
    public function isRegion()
    {
        ...
        $country_code = \Setting::get('shop.sms.country_code');

        return $this->successJson('是否不填写区域', ['is_region' => $is_region,'region_hide' => $region_hide,'country_code' => $country_code]);
    }
