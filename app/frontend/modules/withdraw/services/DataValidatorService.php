...
class DataValidatorService
{
    ...
    public function validator()
    {
        ...
        $max_roll_out_limit = $this->getMaxRollOutLimit();
        if (bccomp($amount, $max_roll_out_limit, 2) == 1 && bccomp($max_roll_out_limit, 0, 2) == 1) {
            throw new AppException("{$type_name}提现金额不能大于{$max_roll_out_limit}元");
        }
     ...
     * @return float
     */
    private function getMaxRollOutLimit()
    {
        return $this->getIncomeSet('max_roll_out_limit');
    }
