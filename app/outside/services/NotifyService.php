...
class NotifyService
{
    ...
    {
        $hashSign = hash_hmac('sha256', $this->toQueryString($this->responseData), $this->getSecret());
    ...
    {
        return strtoupper(md5($this->toQueryString($this->responseData).'&secret='.$this->getSecret())) == $this->responseData['sign'];
    }
