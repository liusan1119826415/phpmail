...
//         app\common\providers\BroadcastServiceProvider::class,
		...
		app\common\providers\ExportServiceProvider::class,
        ...
        // 邮件
        \Illuminate\Mail\MailServiceProvider::class,
        app\common\providers\ProjectServiceProvider::class,
...
//    'AUTH_PASSWORD' => env('PLUGIN_MARKET_SOURCE', ''),
    ...
    'KEFU_URL'=>"https://help.abangmi.cn/buyer",
    "COOKIE_URL"=>".abangmi.cn",
    "SEARCH_URL"=>"http://127.0.0.1:8009",
    "IAPP"=>1,
    "KEFU_API"=>"https://kefu.abangmi.cn/"
];
