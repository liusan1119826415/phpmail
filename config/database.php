...
if (isset($config)) {
    ...
    if (isset($config['db']['kefu'])) {
        $kefu_host = $config['db']['kefu']['host'];
        $kefu_port = $config['db']['kefu']['port'];
        $kefu_db = $config['db']['kefu']['database'];
        $kefu_username = $config['db']['kefu']['username'];
        $kefu_password = $config['db']['kefu']['password'];
        $kefu_prefix = $config['db']['kefu']['tablepre'];
    }
...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'kefu' => [
            'driver' => 'mysql',
            'host' => env('DB2_HOST', $kefu_host),
            'port' => env('DB2_PORT', $kefu_port),
            'database' => env('DB2_DATABASE', $kefu_db),
            'username' => env('DB2_USERNAME', $kefu_username),
            'password' => env('DB2_PASSWORD', $kefu_password),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => $kefu_prefix,
            'strict' => false,
